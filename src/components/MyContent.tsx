...
const MyContent = () => {
  ...
  return (
    <>
      <div className="flex ">
        <div className="flex justify-between h-full w-5/6 mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <div className="ml-28">
