...
import pic from '../../../../public/Programs_thumbnail/cardio/cardio_beginner.png'
...
import CardioBeginnerDay1 from './CardioBeginnerDay/CardioBeginnerDay1'
import CardioBeginnerDay2 from './CardioBeginnerDay/CardioBeginnerDay2'
import CardioBeginnerDay3 from './CardioBeginnerDay/CardioBeginnerDay3'
import CardioBeginnerDay5 from './CardioBeginnerDay/CardioBeginnerDay5'
import CardioBeginnerDay6 from './CardioBeginnerDay/CardioBeginnerDay6'
import RestDay from './RestDay'
import CardioBeginnerDay4 from './CardioBeginnerDay/CardioBeginnerDay4'
    ...
    <>
      ...
      <div className={`${classes.container} flex`}>
        ...
        <div className={`  w-full`}>
          <p className={`${classes.Title} ml-10`}>Low Impact cardio workout</p>
