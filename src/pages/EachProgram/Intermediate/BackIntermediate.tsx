...
import BackBeginnerDay1 from './BackIntermediateDay/BackIntermediateDay1'
import BackBeginnerDay2 from './BackIntermediateDay/BackIntermediateDay2'
import BackBeginnerDay3 from './BackIntermediateDay/BackIntermediateDay3'
import BackBeginnerDay5 from './BackIntermediateDay/BackIntermediateDay5'
import BackBeginnerDay6 from './BackIntermediateDay/BackIntermediateDay6'
import RestDay from './RestDay'

function BackBeginner() {
  return (
    <>
      <Navbar />
