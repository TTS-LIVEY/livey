...
import pic from '../../../../public/Programs_thumbnail/shoulder/shoulder_beginner.png'
...
import ShoulderBeginnerDay1 from './ShoulderIntermediateDay/ShoulderIntermediateDay1'
import ShoulderBeginnerDay2 from './ShoulderIntermediateDay/ShoulderIntermediateDay2'
import ShoulderBeginnerDay3 from './ShoulderIntermediateDay/ShoulderIntermediateDay3'
import ShoulderBeginnerDay5 from './ShoulderIntermediateDay/ShoulderIntermediateDay5'
import ShoulderBeginnerDay6 from './ShoulderIntermediateDay/ShoulderIntermediateDay6'
import RestDay from './RestDay'

function ShoulderBeginner() {
  return (
    <>
      <Navbar />
        ...
        <div className={`  w-full`}>
          ...
          <div className="mt-3 ml-5">
            <Tabs>
              ...
              {/*  */}
              <TabPanel className={`${classes.TabPanel} rounded-t-3xl rounded-b-3xl shadow-xl`}>
                <ShoulderBeginnerDay5 />
              </TabPanel>
              {/*  */}
              <TabPanel className={`${classes.TabPanel} rounded-t-3xl rounded-b-3xl shadow-xl`}>
                <ShoulderBeginnerDay6 />
              </TabPanel>
              {/*  */}
