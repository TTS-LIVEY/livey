...
import arms1 from '../../../../../public/Programs_thumbnail/arms/arms_beginner.png'
import arms2 from '../../../../../public/Programs_thumbnail/arms/arms_intermediate.png'
import arms3 from '../../../../../public/Programs_thumbnail/arms/arms_advance.png'

function BicepAndTricep() {
  return (
    <div className="flex gap-2 pb-10 pt-3">
      {/*  */}
      <div className={`${classes.card} bg-white w-1/4 mx-auto mt-5 pb-4 rounded-3xl shadow-md`}>
        <img src={arms1} className={`mx-auto rounded-t-3xl`} />
      ...
      {/*  */}
      <div className={`${classes.card} bg-white w-1/4 mx-auto mt-5 pb-4 rounded-3xl shadow-md`}>
        <img src={arms2} className={`mx-auto rounded-t-3xl`} />
        <div className={`${classes.Tags} flex gap-3 mt-5 mb-3 px-5`}>
      ...
      {/*  */}
      <div className={`${classes.card} bg-white w-1/4 mx-auto mt-5 pb-4 rounded-3xl shadow-md`}>
        <img src={arms3} className={`mx-auto rounded-t-3xl`} />
        <div className={`${classes.Tags} flex gap-3 mt-5 mb-3 px-5`}>
